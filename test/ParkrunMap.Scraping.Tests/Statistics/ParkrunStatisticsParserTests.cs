            ...
            new List<object[]>
            {
                new object[]
                {
                    ...
                    new ParkrunStats
                    {
                        ...
                        TotalRunners = 1579,
                        TotalRuns = 5459,
                        AverageRunnersPerWeek = 107.0,
                        AverageSecondsRan = (int) new TimeSpan(0, 0, 31, 45).TotalSeconds,
                        TotalSecondsRan = (long) new TimeSpan(120, 9, 23, 39, 0).TotalSeconds,
                        BiggestAttendance = 171,
                        TotalKmDistanceRan = 27295
                    }
                },
                new object[]
                {
                    ...
                    new ParkrunStats
                    {
                        ...
                        TotalSecondsRan = (long) new TimeSpan(82, 20, 4, 52, 0).TotalSeconds +
                ...
                new object[]
                {
                    ...
                    new ParkrunStats
                    {
                        ...
                        TotalSecondsRan = (long) new TimeSpan(273, 8, 42, 23, 0).TotalSeconds +
                                          (long) TimeSpan.FromDays(365).TotalSeconds,
                ...
                new object[]
                {
                    ...
                    new ParkrunStats
                    {
                        ...
                        TotalSecondsRan = (long) new TimeSpan(173, 22, 2, 23).TotalSeconds +
                                          (long) TimeSpan.FromDays(5 * 365).TotalSeconds,
