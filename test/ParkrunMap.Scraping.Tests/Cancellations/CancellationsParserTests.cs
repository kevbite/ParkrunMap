            ...
            using (var cancellationsPage = File.OpenRead(@".\data\cancellations.html"))
            {
                ...
                cancellations.Should().BeEquivalentTo(new[]
                {
                    new ParkrunCancellation(new DateTime(2018,12,29), "Bodelwyddan Castle parkrun",
                        new Uri("http://www.parkrun.org.uk/bodelwyddancastle/"), "Estate closed for festive period"),
                    new ParkrunCancellation(new DateTime(2018,12,29), "Dudley parkrun",
                        new Uri("http://www.parkrun.org.uk/dudley/"), "Dell Stadium closed due to DMBC shutdown over Xmas"),
                    new ParkrunCancellation(new DateTime(2018,12,29), "Hay Lodge parkrun",
                        new Uri("http://www.parkrun.org.uk/haylodge/"), "High winds"),
                    new ParkrunCancellation(new DateTime(2018,12,29), "Lochore Meadows parkrun",
                        new Uri("http://www.parkrun.org.uk/lochoremeadows/"), "Unknown (HQ)"),
                    new ParkrunCancellation(new DateTime(2018,12,29), "Mulbarton parkrun",
                        new Uri("http://www.parkrun.org.uk/mulbarton/"), "Protocols to install new ED"),
                    new ParkrunCancellation(new DateTime(2018,12,29), "Newent parkrun, Forest of Dean",
                        new Uri("http://www.parkrun.org.uk/newent/"), "School grounds are closed for Christmas holiday"),
                    new ParkrunCancellation(new DateTime(2018,12,29), "Omagh parkrun",
                        new Uri("http://www.parkrun.org.uk/omagh/"), "course closed"),
                    new ParkrunCancellation(new DateTime(2018,12,29), "Sandwell Valley parkrun",
                        new Uri("http://www.parkrun.org.uk/sandwellvalley/"), "No access to an AED as the Park Farm is closed."),
                    new ParkrunCancellation(new DateTime(2018,12,29), "Vogrie parkrun",
                        new Uri("http://www.parkrun.org.uk/vogrie/"), "Run cancelled due to high winds forecast"),

                    new ParkrunCancellation(new DateTime(2019,01,05), "Bodelwyddan Castle parkrun",
                        new Uri("http://www.parkrun.org.uk/bodelwyddancastle/"), "Run Director not available - Cross Country Champs"),
                    new ParkrunCancellation(new DateTime(2019,01,05), "Bramley parkrun",
                        new Uri("http://www.parkrun.org.uk/bramley/"), "removal of asbestos from a park facility"),
                    new ParkrunCancellation(new DateTime(2019,01,05), "Witton parkrun",
                        new Uri("http://www.parkrun.org.uk/witton/"), "Cross Country Event in the park"),
                    ...
                    new ParkrunCancellation(new DateTime(2019,01,12), "Prospect parkrun",
                        new Uri("http://www.parkrun.org.uk/prospect/"), "Hampshire Cross Country League event in the park"),
